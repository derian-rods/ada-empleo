...
<template>
  <DataTable
    ...
    :global-filter-fields="['code', 'subject', 'project', 'application', 'status']"
  >
    ...
    <Column field="timeEntriesCount" header="Imputaciones" sortable style="width: 100px" />
    <Column field="peopleCount" header="Personas" sortable style="width: 80px" />
