...
<template>
  ...
  >
    ...
    <Column
      field="profitRelatedHours"
      header="Horas ganancia"
      sortable
      style="width: 120px"
    >
      <template #body="{ data }">
        <span class="difference-value profit">{{
          fmt(data.profitRelatedHours)
        }}</span>
      </template>
    </Column>

    <Column
      field="lossRelatedHours"
      header="Horas pérdida"
      sortable
      style="width: 120px"
    >
      <template #body="{ data }">
        <span v-if="data.lossRelatedHours > 0" class="difference-value loss">
